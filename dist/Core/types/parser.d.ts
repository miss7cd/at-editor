...
export type Callbacks = {
     ...
     * 遍历节点开始
     */
    onOpen?: (node: NodeInterface, name: string, attributes: {
        [k: string]: string;
    }, styles: {
        [k: string]: string;
    }) => boolean | void;
     ...
     * 遍历节点结束
     */
    onClose?: (node: NodeInterface, name: string, attributes: {
        [k: string]: string;
    }, styles: {
        [k: string]: string;
    }) => void;
...
export interface ParserInterface {
     ...
     */
    traverse(node: NodeInterface, schema: SchemaInterface | null, conversion: ConversionInterface | null, callbacks: Callbacks, includeCard?: boolean): void;
    /**
