...
export type RequestData = Record<string, RequestDataValue> | FormData | (() => Promise<Record<string, RequestDataValue> | FormData>);
...
export interface AjaxInterface {
     ...
     * @param error
     */
    getRequest(success: (data: any) => void, error: (errorMsg: string, request?: XMLHttpRequest) => void): Promise<XMLHttpRequest | undefined>;
    /**
     * 中断当前请求
     */
    abort: () => void;
...
export type UploaderOptions = {
     ...
     * 上传中
     */
    onUploading?: (file: File, progress: {
        percent: number;
    }) => void;
    /**
     * 上传错误
