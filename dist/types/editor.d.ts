import { PluginEntry, CardEntry, LanguageInterface, NodeInterface, CommandInterface, CardModelInterface, PluginModelInterface, NodeModelInterface, NodeIdInterface, MarkModelInterface, InlineModelInterface, BlockModelInterface, EventInterface, SchemaInterface, ConversionInterface, ClipboardInterface, CardInterface, PluginOptions, RangeInterface } from './index';
import { ListModelInterface } from './list';
import { EventListener } from './node';
import { Node as ModelNode } from '../Core/model';
...
export interface EditorInterface<T extends EditorOptions = EditorOptions> {
     ...
     * @param options
     */
    on(eventType: 'parse:node', listener: (node: ModelNode) => false | void, options?: boolean | AddEventListenerOptions): void;
    /**
     ...
     * @param options
     */
    off(eventType: 'parse:node', listener: (node: ModelNode) => false | void, options?: boolean | AddEventListenerOptions): void;
    /**
     * 解析DOM节点，生成文本，遍历子节点时触发。返回false跳过当前节点
     * @param node 当前遍历的节点
     * @param attributes 当前节点已过滤后的属性
     ...
     * @param options
     */
    trigger(eventType: 'parse:node', listener: (node: ModelNode) => false | void, options?: boolean | AddEventListenerOptions): void;
    /**
     * 解析DOM节点，生成文本，遍历子节点时触发。返回false跳过当前节点
     * @param node 当前遍历的节点
     * @param attributes 当前节点已过滤后的属性
