 ...
 * 规则值类型
 */
export type SchemaValueBase = RegExp | Array<string> | string | ((propValue: string) => boolean) | '@number' | '@length' | '@color' | '@url' | '*';
/**
 * 规则对象值类型
 */
...
export interface SchemaInterface {
     ...
     * @param force 是否强制比较值
     */
    checkValue(rule: SchemaAttributes | SchemaStyle, attributesName: string, attributesValue: string, force?: boolean): boolean;
    /**
     * 过滤节点样式
     * @param styles 样式
     * @param rule 规则
