...
export interface ListModelInterface {
     ...
     * @param value 卡片值
     */
    toCustomize(blocks: Array<NodeInterface> | NodeInterface, cardName: string, value?: any, tagName?: 'ol' | 'ul'): Array<NodeInterface> | NodeInterface;
    /**
     * 将节点转换为列表节点
     * @param blocks 节点
     ...
     */
    toNormal(blocks: Array<NodeInterface> | NodeInterface, tagName?: 'ul' | 'ol', start?: number): Array<NodeInterface> | NodeInterface;
    /**
     * 判断选中的区域是否在列表的开始
     * 选中的区域
     */
