...
import { DropdownButtonOptions, DropdownSwitchOptions, ToolbarItemOptions } from './toolbar';
import { CardActiveTrigger, CardType, SelectStyleType } from '../Core/card/enum';
...
export interface CardModelInterface {
     ...
     * @param ignoreEditable 是否忽略可编辑节点
     */
    find<E extends CardValue = object, T extends CardInterface<E> = CardInterface<E>>(selector: NodeInterface | Node | string, ignoreEditable?: boolean): T | undefined;
    /**
     ...
     * @param rang 选区
     */
    getSingleSelectedCard<E extends CardValue = object, T extends CardInterface<E> = CardInterface<E>>(rang: RangeInterface): T | undefined;
    /**
     * 插入卡片
     * @param range 选区
     * @param card 卡片
     ...
     */
    updateNode<E extends CardValue = object, T extends CardInterface<E> = CardInterface<E>>(card: T, value: Partial<E>, ...args: any): void;
    /**
     * 激活卡片节点所在的卡片
     * @param node 节点
     * @param trigger 激活方式
     ...
     * @param args 插入时渲染时额外的参数
     */
    insert<E extends CardValue = object, T extends CardInterface<E> = CardInterface<E>>(name: string, value?: Partial<E>, ...args: any): T;
    /**
     * 更新卡片
     ...
     * @param args 更新时渲染时额外的参数
     */
    update<V extends CardValue = CardValue>(selector: NodeInterface | Node | string, value: Partial<V>, ...args: any): void;
    /**
     * 替换卡片
     * @param source 源卡片
     * @param name 新卡片名称
     ...
     */
    replace<E extends CardValue = object, T extends CardInterface<E> = CardInterface<E>>(source: CardInterface, name: string, value?: Partial<E>, ...args: any): T;
    /**
     * 移除卡片
     * @param selector 卡片选择器
