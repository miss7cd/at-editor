...
import { Model, Operation, Element, Node } from '../Core/model'
...
export interface EngineOptions extends EditorOptions {
    ...
    markdown?: {
        ...
        mode?: 'confirm' | false;
         // 检测是否为 markdown 语法，如果为 true 则将 markdown 转换后粘贴
...
export interface EngineInterface<T extends EngineOptions = EngineOptions> extends EditorInterface<T> {
    ...
    on(eventType: 'parse:value', listener: (node: NodeInterface, attributes: { [key: string]: string }, styles: { [key: string]: string }, value: Array<string>,) => boolean | void, options?: boolean | AddEventListenerOptions,): void;
    ...
    on(
        ...
        listener: (node: NodeInterface, attributes: { [key: string]: string }, styles: { [key: string]: string }, value: Array<string>,) => boolean | void,
        options?: boolean | AddEventListenerOptions,
    ): void;
